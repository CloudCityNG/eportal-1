...
<div class="col-md-6 col-md-offset-4">
	<?php if($status=='complete'){?>
		<div class="alert alert-success text-center"> A new Private account has been successfully created.</div>
	<?php }?>
...
<div class="col-md-6 col-md-offset-4 breadcrumb img-thumbnail">
	<div class="h3 text-center">
		Create new account<br /> <small> Private account</small>
	</div>
	<br />
	<div class="thumbnail">
      <div class="caption text-center">
		<?php
			...
			echo form_open('administration/add_user_normal_validate',$formattributes);
		?>
