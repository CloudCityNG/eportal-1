<div class="container">
	<div class="panel panel-default">
		<div class="panel-heading">
	    		<center><h3 class="panel-title"><strong>Business users</strong></h3></center>
	    </div>
	    
	    <div class="panel-body"> 
<?php
	
	foreach ($db_business_user as $info) 
	{
		echo '<div class="col-md-10 col-md-offset-1 navbar-set-margin-bottom">
			...
			<div class="col-sm-7">
				<div class="row">';
					if(isset($info->bname)){
				   				 echo '<u><b>'.$info->bname.'</b>&nbsp;&nbsp;'; 
								 echo '('.$info->fname.'&nbsp;'.$info->lname.')</u>'; 
							}else if(isset($info->fname) || isset($info->lname)){
								 echo '<u>'.$info->fname.'&nbsp;'.$info->lname.'</u>'; 
							}
					if ((time()-$info->registeredon) > 432000) {
						//registered up to 5 days
